...
CREATE TABLE "new_Account" (
    ...
    "brandLogoUrl" TEXT,
    "brandLogoAssetPath" TEXT,
    "brandLogoAssetUrl" TEXT,
    "introKind" TEXT NOT NULL DEFAULT 'none',
    "introAssetPath" TEXT,
    "introAssetUrl" TEXT,
    "outroKind" TEXT NOT NULL DEFAULT 'none',
    "outroAssetPath" TEXT,
    "outroAssetUrl" TEXT,
...
INSERT INTO "new_Account" ("brandColors", "brandLogoUrl", "brandTone", "businessName", "consecutiveApprovals", "createdAt", "email", "extraCredits", "guestPortalEnabled", "id", "introEnabled", "outroEnabled", "outroText", "passwordHash", "periodEventsUsed", "periodStartedAt", "planEventsPerMonth", "role", "trustModeEnabled", "watermarkEnabled", "watermarkOpacity", "watermarkPosition", "webhookSecret") SELECT "brandColors", "brandLogoUrl", "brandTone", "businessName", "consecutiveApprovals", "createdAt", "email", "extraCredits", "guestPortalEnabled", "id", "introEnabled", "outroEnabled", "outroText", "passwordHash", "periodEventsUsed", "periodStartedAt", "planEventsPerMonth", "role", "trustModeEnabled", "watermarkEnabled", "watermarkOpacity", "watermarkPosition", "webhookSecret" FROM "Account";
DROP TABLE "Account";
